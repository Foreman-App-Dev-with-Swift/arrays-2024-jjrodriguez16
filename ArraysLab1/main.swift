...
var walkingChallenges : [String] = ["walk 2 miles a day"]
var runningChallenges : [String] = ["run 7 times a week"]
var liftingChallenges : [String] = ["lift weights 4 times this week"]
